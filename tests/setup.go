...
// Scalar
func buildNScalarVaultEvents(stakerHash string, numOfEvent int) []*client.ActiveVaultEvent {
	var scalarStakingEvents []*client.ActiveVaultEvent
	for i := 0; i < numOfEvent; i++ {
		scalarStakingEvent := client.NewActiveVaultEvent(
